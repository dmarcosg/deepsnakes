...
def plot_snakes(snake,snake_hist,GT,mapE, mapA, mapB, mapK, grads_arrayE, grads_arrayA, grads_arrayB, grads_arrayK, image):
    # Plot result
...
grad_predK = tf.placeholder(tf.float32, shape=[128, 128, 1, batch_size])
